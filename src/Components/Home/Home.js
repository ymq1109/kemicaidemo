...
class Home extends Component {
    constructor(props) {
        ...
        this.state = {
            lottery: [
                { name: '双色球', en: 'Ssq', imgurl: require("./caipiao/1.ssq@2x.png"), subtitle: '暂停销售' },
                { name: '大乐透', en: 'BigHip', imgurl: require("./caipiao/2.dlt@2x.png"), subtitle: '奖池超72亿' },
                ...
                { name: '3D', en: 'S3d', imgurl: require("./caipiao/6d@2x.jpeg"), subtitle: '暂停销售' },
        ...
        return (
            <div className="Home">
                ...
                <content className="Content">
                    {
                        this.state.lottery.map((item,index) => {
                            return (
                                <Fragment>
                                    <div key={item.name +index} onClick={this.goToGame.bind(this, { en: item.en, name: item.name })}>
                                        <div className="Imag">
                                            <img src={item.imgurl} alt={item.name} key={item.name}/>
                                        </div>
                                        <div className="Font">
                                            <h4>{item.name}</h4>
